...
8. **Método de trabajo (OBLIGATORIO en piezas con contenido)** → https://brand.magoya.com/ai/precedencia.json  <- quién gana cuando dos reglas chocan + contrato de entrega
